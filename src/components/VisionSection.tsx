...
export default function VisionSection() {
  ...
  return (
    <section id="vision" ref={sectionRef} className="py-24 px-6 relative overflow-hidden">
      {/* Background Video shifted from Hero */}
      <div className="absolute inset-0 w-full h-full z-0">
        ...
        {/* Gradient Overlay to blend smoothly with adjacent black sections */}
        <div className="absolute inset-0 bg-gradient-to-b from-background via-background/30 to-background z-10" />
      </div>
